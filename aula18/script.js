...
listarOrigamis.forEach((origami, posicao) => {
  linha.innerHTML += `
        <div class="col-12 col-sm-6 col-lg-4 d-flex">
          <div class="card card-hover h-100 w-100 shadow-sm" style="cursor: pointer;" onclick="abrirModel('${posicao}')">
...
function mudarTema() {
  ...
  if (tema === "dark") {
    ...
    document.querySelector("#alterarTema").innerHTML =
